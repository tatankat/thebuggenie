<div class="greybox" style="padding: 0; margin-top: 5px;" id="teambox_<?= $team->getID(); ?>">
    <div style="padding: 5px; position: relative;">
        ...
        <div style="position: absolute; right: 12px; top: 12px;">
            ...
            <ul id="team_<?= $team->getID(); ?>_more_actions_dropdown" style="font-size: 1.1em; width: 200px; top: 23px; margin-top: 0; text-align: right; z-index: 1000;" class="simple_list rounded_box white shadowed popup_box more_actions_dropdown">
                <li>
                    <?= javascript_link_tag(__('Add member(s) to this team'), array('onclick' => '$(\'addmember_team_'.$team->getID().'\').toggleClassName(\'force-active\');')); ?>
                </li>
                <li>
        ...
        <?php include_component('main/identifiableselector', array(    'html_id'        => "addmember_team_{$team->getID()}",
                                                                ...
                                                                'callback'             => "TBG.Config.Team.addMember('".make_url('configure_users_add_team_member', array('team_id' => $team->getID(), 'user_id' => '%identifiable_value'))."', ".$team->getID().", '%identifiable_value');$('addmember_team_{$team->getID()}').toggleClassName('force-active');",
