<li id="edition_<?php echo $edition->getID(); ?>_box" class="rounded_box invisible borderless">
    ...
    <div class="edition_actions">
        ...
        <ul class="simple_list rounded_box white shadowed more_actions_dropdown popup_box" onclick="$('edition_<?php echo $edition->getID(); ?>_more_actions').toggleClassName('button-pressed');">
