<li id="show_component_<?php print $component->getID(); ?>" class="hover_highlight">
    ...
    <div class="component_actions">
        ...
        <ul class="simple_list rounded_box white shadowed more_actions_dropdown popup_box" onclick="$('component_<?php echo $component->getID(); ?>_more_actions').toggleClassName('button-pressed')">
