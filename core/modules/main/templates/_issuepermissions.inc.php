    ...
    <div id="backdrop_detail_content" class="backdrop_detail_content">
        ...
        <div id="acl-users-teams-selector" style="<?php if($issue->isUnlocked() && $issue->isUnlockedCategory()): ?> display: none;<?php endif; ?>">
            <h4 style="margin-top: 10px;">
                <?php echo javascript_link_tag(__('Add a user or team'), array('onclick' => "$('popup_find_acl_{$issue->getID()}').toggleClassName('force-active');", 'style' => 'float: right;', 'class' => 'button button-silver')); ?>
