        ...
        <div class="dashboard_client_info">
            ...
            <?php if ($tbg_user->canAccessConfigurationPage(\thebuggenie\core\framework\Settings::CONFIGURATION_SECTION_USERS)): ?>
                <div class="project_header_right button-group">
                    ...
                    <ul style="margin-top: 28px; font-size: 1.1em;" class="simple_list rounded_box white shadowed popup_box more_actions_dropdown">
                        <li><?php echo javascript_link_tag(fa_image_tag('user-plus').__('Add member(s) to this client'), array('onclick' => '$(\'addmember_client_'.$client->getID().'\').toggleClassName(\'force-active\');')); ?></li>
            ...
            <?php include_component('main/identifiableselector', [
                ...
                'allow_clear'   => false,
                'allow_close'   => true,
                'style'         => ['right' => '12px', 'top' => '35px', 'z-index' => '100000'],
                'absolute'      => true
            ]); ?>
            <table>
                <tr>
